...
const projects = [
  {
    ...
    description: 'Будівництво сучасного заводу з виробництва металоконструкцій площею 5000 кв.м. Проект включав повний цикл робіт від фундаменту до введення в експлуатацію.',
    year: '2023',
    area: '5000 кв.м',
    duration: '8 місяців',
  ...
  },
  {
    ...
    description: 'Будівництво багатофункціонального торговельного центру з підземним паркінгом та сучасними інженерними системами.',
    year: '2022',
    area: '12000 кв.м',
    duration: '14 місяців',
  ...
  },
  {
    ...
    description: 'Будівництво сучасного житлового комплексу з енергоефективними технологіями та розвиненою інфраструктурою.',
    year: '2023',
    area: '25000 кв.м',
    duration: '18 місяців',
    client: 'ТОВ "Житлобуд"',
  ...
  },
  {
    ...
    description: 'Будівництво великого логістичного центру з автоматизованими системами зберігання та обробки вантажів.',
    year: '2022',
    area: '15000 кв.м',
    duration: '10 місяців',
      ...
      <div class="container">
        <div class="page-hero-content">
          ...
          <p class="page-subtitle">
            Ознайомтеся з нашими завершеними проектами та досягненнями у сфері будівництва
          </p>
        </div>
      </div>
    </section>
          ...
          <div class="modal-info">
            ...
            <div class="project-details">
              <div class="detail-item">
                <strong>Рік завершення:</strong> {{ selectedProject.year }}
              </div>
              <div class="detail-item">
                <strong>Площа:</strong> {{ selectedProject.area }}
              </div>
              <div class="detail-item">
                <strong>Тривалість:</strong> {{ selectedProject.duration }}
              </div>
              <div class="detail-item">
                <strong>Клієнт:</strong> {{ selectedProject.client }}
              </div>
            </div>
